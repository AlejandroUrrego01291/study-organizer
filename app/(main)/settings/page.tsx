        ...
        <div className="p-4 md:p-8 space-y-8 max-w-5xl">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-base text-gray-500 mt-0.5">Personaliza tu experiencia</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="space-y-2 mb-4">
                    {categories.length === 0 && (
                        <p className="text-sm text-gray-700 text-center py-4">No hay categorías aún</p>
                    )}
                    {categories.map((cat) => (
            ...
            {/* POMODORO */}
            <div className="bg-white/95 rounded-2xl border border-gray-200 shadow-sm p-6 backdrop-blur-sm">
                <h2 className="text-base font-bold text-gray-900 mb-4">🍅 Configuración Pomodoro</h2>
                    ...
                    {[
                        ...
                        <div key={item.key}>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-800 text-gray-900"
                            />
                        </div>
                    ))}
                </div>
