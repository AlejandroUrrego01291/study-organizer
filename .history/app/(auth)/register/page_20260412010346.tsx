        ...
        <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl p-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold tracking-tighter bg-gradient-to-r from-gray-900 via-indigo-700 to-violet-700 bg-clip-text text-transparent">📚 Study Organizer</h1>
