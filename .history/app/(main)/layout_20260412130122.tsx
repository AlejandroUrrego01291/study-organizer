            ...
            <aside className="hidden md:flex w-72 bg-white/95 backdrop-blur-xl border-r border-gray-100 shadow-xl flex-col fixed h-full z-20">
                ...
                <div className="p-6 border-t border-gray-100">
                    <form action={async () => { "use server"; await signOut({ redirectTo: "/login" }) }}>
                        <button type="submit" className="group flex items-center gap-3 w-full px-6 py-4 rounded-2xl text-gray-600 hover:bg-red-50 hover:text-red-600 transition-all duration-200 active:scale-[0.98] border border-transparent hover:border-red-100 font-medium text-[15px]">
