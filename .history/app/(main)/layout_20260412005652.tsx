    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-zinc-100 to-gray-50 flex">
            ...
            <aside className="hidden md:flex w-72 bg-white/95 backdrop-blur-xl border-r border-gray-100 shadow-xl flex-col fixed h-full z-20">
                ...
                {/* Navegación - Botones más grandes y con hover notorio */}
                <nav className="flex-1 p-6 space-y-2">
                    <Link
                        href="/board"
                        className="group flex items-center gap-3 px-6 py-4 rounded-2xl text-gray-700 hover:bg-indigo-600 hover:text-white hover:shadow-xl hover:shadow-indigo-200 transition-all duration-300 active:scale-[0.98] border border-transparent hover:border-indigo-500"
                    >
                ...
                <div className="p-6 border-t border-gray-100 mt-auto">
                    ...
                    >
                        <button
                            type="submit"
                            className="group flex items-center gap-3 w-full px-6 py-4 rounded-2xl text-gray-600 hover:bg-red-600 hover:text-white hover:shadow-xl hover:shadow-red-200 transition-all duration-300 active:scale-[0.98] border border-transparent hover:border-red-500"
                        >
