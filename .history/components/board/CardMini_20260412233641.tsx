...
export default function CardMini({ card, onClick, onDelete }: Props) {
    ...
    return (
        <div
            className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden cursor-pointer hover:shadow-md transition-shadow group w-full box-border"
            onClick={onClick}
        >
